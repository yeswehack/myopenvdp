...
Object.assign(form, {
  ...
  details: {
    ...
    env: 'firefox, chrome',
    report: `## Description
General description of this kind of vulnerability and in which *workflow* of the application it is part.
...
## Risk
Here you can describe risks for the application, its users and the company

## Remediation
Here you can provide vulnerability remediation elements to help the program manager to the report treatment

* * *

### Markdown Tips

Mardown feature can be used like :
# title 1
## Title 2
### Title 3
#### Title 4
...
**You can add link to your attachement by pasting attachement ID in the report or directly insert image**

Put an attachement link : YWH-RXXX

Insert an image : {YWH-RXXX}
`,
  },
  attachments: (() => {
    const encoder = new TextEncoder();
    const requestContent = '*'.repeat(30000);
    ...
    return [
      {
        filename: 'curl-request.txt',
        size: requestContent.length,
        strSize: humanStorageSize(requestContent.length),
        content: encoder.encode(requestContent),
      },
      {
        filename: 'response.json',
        size: jsonContent.length,
        strSize: humanStorageSize(jsonContent.length),
